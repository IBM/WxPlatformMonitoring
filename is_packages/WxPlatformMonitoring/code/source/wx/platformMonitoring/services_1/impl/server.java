...
// -----( CREATED: 2017-01-15 00:58:19 CET
...

{
	...
	public static final void setExtendedSettings (IData pipeline)
        throws ServiceException
	{
		// --- <<IS-START(setExtendedSettings)>> ---
		// @sigtype java 3.5
		...
		if( key == null ) {
			throw new ServiceException("Cannot set extended settings for a null key, i.e. please provide the name of the exteded settings which should be set to '" + value + "'.");
		}
		
		com.wm.util.Config.setProperty(key, value);
		
		
		IDataCursor pipelineCursor_1 = pipeline.getCursor();
		IDataUtil.put( pipelineCursor_1, "success", "true" );
